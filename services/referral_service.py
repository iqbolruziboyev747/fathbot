...
if config.USE_FIRESTORE:
    try:
        from database.firestore_service import firestore_referral_service as referral_service
        print("✅ Firestore Referral Service ishlatilmoqda")
    except Exception as e:
        print(f"⚠️ Firestore Referral Service yuklanmadi: {e}")
...
if not config.USE_FIRESTORE:
    ...
    print("✅ SQLite Referral Service ishlatilmoqda")
