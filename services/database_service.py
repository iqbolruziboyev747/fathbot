...
# Firestore yoki SQLite dan birini tanlaydi
# ============================================
...
# Firestore yoki SQLite tanlash
if config.USE_FIRESTORE:
    # Firestore ishlatish
    try:
        from database.firestore_service import (
            firestore_trading_db as _trading_db,
            firestore_license_db as _license_db
        )
        trading_db = _trading_db
        license_db = _license_db
        print("✅ Firestore database ishlatilmoqda")
    except Exception as e:
        print(f"⚠️ Firestore yuklanmadi: {e}")
        print("⚠️ SQLite ga qaytildi")
        config.USE_FIRESTORE = False

if not config.USE_FIRESTORE:
    # SQLite ishlatish (legacy)
    ...
    class TradingDB:
        """Trading database operatsiyalari - SQLite"""
    ...
    class LicenseDB:
        """License database operatsiyalari - SQLite"""
    ...
    print("✅ SQLite database ishlatilmoqda")
